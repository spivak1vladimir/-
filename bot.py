...
# ---------------- НАСТРОЙКИ ----------------
TOKEN = "8429687481:AAEeGhOjiRp1N1wa9xd0vG3vk5O8nGOhpj0"
ADMIN_CHAT_ID = 194614510
MAX_SLOTS = 15
DATA_FILE = "registered_users.json"

RUN_DATETIME = datetime(2026, 3, 22, 11, 0)  # дата и время старта
RUN_DATE_TEXT = "22.03.26"
RUN_TITLE_TEXT = "Выбегаем из Cosmic latte, кофейня, Якиманский пер., 6, стр. 1, Москва вместе с GSB"
START_POINT = "Cosmic latte, кофейня, Якиманский пер., 6, стр. 1, Москва"
START_MAP_LINK_10KM = "https://yandex.ru/maps/-/CPufVPIR"  # оставляем ссылку прежней
